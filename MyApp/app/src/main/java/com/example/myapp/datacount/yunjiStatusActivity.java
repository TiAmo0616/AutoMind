...
import com.example.myapp.datacount.StatusAdapter;
...
public class yunjiStatusActivity extends AppCompatActivity implements View.OnClickListener{
    ListView cityLv;
    List<String> mDatas;//列表数据源
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yunjistatus);
        cityLv = findViewById(R.id.city_lv);
        mDatas = new ArrayList<>();
        mDatas = getIdlist();

        cityLv.setAdapter(new StatusAdapter(this,mDatas));
    }
    ...
    public List<String> getIdlist(){
        try {
            ...
            // 查询机器人编号
            String sql = "SELECT id FROM robot where companyName='云迹科技'";
